...
export default function AdminDashboard() {
  ...
  return (
    <div className="admin">
      <h1>Backoffice</h1>
      <p className="sub">Accès par URL uniquement — aucun lien depuis le site public.</p>
      ...
      <div className="kpis">
        <div className="kpi"><b>{products.length}</b><span>Produits en ligne</span></div>
        <div className="kpi"><b>{categories.length}</b><span>Départements</span></div>
        <div className="kpi"><b>{archived.length}</b><span>Produits archivés</span></div>
        <div className="kpi"><b>{sansPrix}</b><span>Sans prix</span></div>
        <div className="kpi"><b>0</b><span>Commandes réelles</span></div>
      </div>
